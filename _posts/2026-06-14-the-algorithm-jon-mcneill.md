...
<figcaption>Fig. 1 — Run the five steps in strict order on a weekly cadence; automate last, always.</figcaption>
</figure>
...
<figcaption>Fig. 2 — The Algorithm as a four-layer control loop: mandate → cadence → execution → measurable output.</figcaption>
</figure>
...
<figcaption>Fig. 3 — Same hunger for efficiency, different starting architecture: lean optimizes in place; the Algorithm resets then rebuilds.</figcaption>
</figure>
...
<figcaption>Fig. 4 — Cycle compression ratios from the book; gains come from deleting gates, not just working harder.</figcaption>
</figure>
...
Reading — _chapter margin notes, pilot metrics, and personal weekly log in progress_
