...
_《传习录》254 条原文见 [传习录（导读）]({{ '/2026/06/17/chuanxilu-wang-yangming/' | relative_url }}) 系列 8 卷；本篇为**大学问**全录。_
...
上一篇：[传习录原文 231–254]({{ '/2026/06/25/chuanxilu-231-254/' | relative_url }})

## 关联阅读

- [阳明心学（导读）— 本站笔记]({{ '/2026/06/22/yangming-xinxue/' | relative_url }})，八大专题、四句教与史案
- [传习录（导读）— 本站笔记]({{ '/2026/06/17/chuanxilu-wang-yangming/' | relative_url }})，诚意与边界栈
