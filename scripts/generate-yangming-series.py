...
def main() -> None:
    ...
    body = "\n".join(
        [
            ...
            "| 4 | 对照 [传习录原文 1–34]({{ '/2026/08/29/chuanxilu-001-034.html' | relative_url }}) |",
            "",
            f"上一篇：[传习录原文 231–254]({rel('2026/09/05/chuanxilu-231-254')})",
            "",
            "## 关联阅读",
            "",
            f"- [阳明心学（导读）— 本站笔记]({rel(HUB_SLUG)})，八大专题、四句教与史案",
            f"- [传习录（导读）— 本站笔记]({rel(CHUANXILU_HUB)})，诚意与边界栈",
            "- [传习录原文 1–34 — 本站笔记]({{ '/2026/08/29/chuanxilu-001-034.html' | relative_url }})",
            "",
            "## 状态",
            "",
